...
import com.newtec.company.service.NewReport2020Service;
...
@RpcClass(value = "NewReport2020Service", http = true)
public class NewReport2020ServiceImpl implements NewReport2020Service {
...
//            ja.add(NewUtils.returnTodayTotalDoubleMsg1("出证数量", res[21], res[26], "证书数量", "其他成果物数量", null, res[22], res[25], null, df));
	...
	public Map<String, Object> findYwsrByZj(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		String sql = "SELECT SUM(CASE" + 
				"             WHEN SUBSTR(INVOICE_DATE, 0, 4) =" + 
				"                  TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') THEN" + 
				"              EX_TAX_PRICE" + 
				"           END) - NVL(SUM(CASE" + 
				"                            WHEN SUBSTR(VOID_TIME, 0, 4) =" + 
				"                                 TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') THEN" + 
				"                             EX_TAX_PRICE" + 
				"                          END)," + 
				"                      0) 年业务收入," + 
	...
	public Map<String, Object> findYwcbByZj(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		String sql = "SELECT SORG_LEVEL3," + 
				"       SUM(payment_amount + i_payment_amount + apport_pay_amount +" + 
				"           continu_payment_amount) AS 业务成本" + 
				"  FROM T_COMPANY_COST_ALL" + 
				" WHERE SUBSTR(pay_end_date, 0, 4) = '2020'" + 
	...
	public Map<String, Object> findYwsrByJw(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		String sql = "SELECT SUM(SYSTEM_EX_TAX_PRICE - VOID_SYSTEM_EX_TAX_PRICE +" + 
				...
				" WHERE SUBSTR(INVOICE_DATE_MONTH, 1, 4) = '2020'" + 
	...
	public Map<String, Object> findCompanyMsgByCompanyYh(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		sql.append("select SORG_LEVEL2," + 
				...
				"           and substr(data_stats_month, 0, 4) = '2020'" + 
				...
				"          FROM T_COMPANY_COST_ALL" + 
				"         where SORG_LEVEL2 not like '%参股%'" + 
				"           and SUBSTR(PAY_END_DATE, 1, 4) = '2020'" + 
				"         GROUP BY SORG_LEVEL2, sorg_level3_id, SORG_LEVEL3)" + 
				" group by SORG_LEVEL2, sorg_level3_id, SORG_LEVEL3" + 
				" order by 年预测收入 desc" );
		System.out.println(sql.toString());
	...
	public Map<String, Object> findCompanyMsgByAreaYh(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		sql.append("SELECT BUSINESS_REGION," + 
				...
				"               0 AS 业务成本" + 
				"          FROM T_ORDER_SERVER" + 
				"         WHERE SUBSTR(CREATE_TIME_ORDER, 0, 4) = '2020'" + 
				...
				"                   and SUBSTR(INVOICE_DATE, 0, 4) = '2020'" + 
				"                 GROUP BY BUSINESS_REGION, SORG_LEVEL3" + 
				"                UNION ALL" + 
				"                SELECT BUSINESS_REGION," + 
				"                       SORG_LEVEL3," + 
				...
				"               0 AS 业务成本" + 
				"          FROM T_ORDER_SERVER" + 
				"         WHERE SUBSTR(WORK_FINISH_TIME, 1, 4) = '2020'" + 
				"           AND BUSINESS_REGION IS NOT NULL" + 
				"         GROUP BY BUSINESS_REGION, SORG_LEVEL3" + 
				"        UNION ALL" + 
				"        SELECT BUSINESS_REGION," + 
				...
				"          FROM T_COMPANY_COST_ALL" + 
				"         WHERE BUSINESS_REGION IS NOT NULL" + 
				"           and SUBSTR(PAY_END_DATE, 0, 4) = '2020'" + 
				"         GROUP BY BUSINESS_REGION, SORG_LEVEL3)" + 
				" GROUP BY BUSINESS_REGION, SORG_LEVEL3" + 
				" order by 预测收入 desc" );
		System.out.println(sql.toString());
	...
	public Map<String, Object> findCompanyMsgByCpx(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append(" SELECT PRODUCT_LINE_NAME_ST1," + 
				...
				"        union all" + 
				"        SELECT PRODUCT_LINE_NAME_ST1," + 
				"               product_id || '-' || product_name as PRODUCT_LINE_NAME," + 
				"               0 as 委托单量," + 
				"               0 as 年业务收入," + 
				"               0 as 预测收入," + 
	...
	public Map<String, Object> findCompanyMsgByCpxName(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		sql.append(" select SORG_LEVEL3," + 
				...
				"               0 业务成本" + 
				"          FROM T_COMP_INVOICE_ALL_MONTH" + 
				"         WHERE SUBSTR(invoice_date_month, 0, 4) = '2020'" + 
				...
				"               SUM(total_cost) 业务成本" + 
				"          FROM T_COMPANY_COST_ALL" + 
				"         where product_id || '-' || product_name = '"+cpxName+"'" + 
				"           and substr(pay_end_date, 0, 4) = '2020'" + 
				"         GROUP BY SORG_LEVEL2, SORG_LEVEL3)" + 
				" group by SORG_LEVEL3" + 
				" order by 年预测收入 desc" );
	...
	public Map<String, Object> findCpxMsgByJsfl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("select * from(" + 
				"SELECT  服务技术大类 as a,'父节点' as b,SUM(委托金额) as c, SUM(开票金额) as d, SUM(成本总额) as e" + 
				...
				"          FROM T_COMPANY_COST_ALL" + 
				"         WHERE SERVICE_MAINCLASS_NAME IS NOT NULL" + 
				"           AND SUBSTR(PAY_END_DATE, 1, 4) =" + 
				"               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"           AND PRODUCT_ID || '-' || PRODUCT_NAME = '"+cpxName+"'" + 
				"         GROUP BY SERVICE_MAINCLASS_NAME, SERVICE_MEDIUMCLASS_NAME)" + 
				" GROUP BY 服务技术大类" + 
				" union" + 
				" SELECT  服务技术大类 as a,服务技术中类 as b,SUM(委托金额) as c, SUM(开票金额) as d, SUM(成本总额) as e" + 
				"  FROM (SELECT SERVICE_MAINCLASS_NAME 服务技术大类," + 
				"               SERVICE_MEDIUMCLASS_NAME 服务技术中类," + 
				"               SUM(SYS_CUR_TOTAL_AMOUNT) 委托金额," + 
				"               0 AS 开票金额," + 
	...
	public Map<String, Object> findCpxMsgByDxfl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("select *" + 
				...
				"                   AND SUBSTR(CREATE_TIME_ORDER, 0, 4) =" + 
				"                       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"                   AND PRODUCT_LINE_UUID || '-' || PRODUCT_LINE_NAME =" + 
				"                       '"+cpxName+"' " + 
	...
	public Map<String, Object> findCpxTableKh(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append(" select *" + 
				...
				"                           AND product_line_uuid || '-' || PRODUCT_LINE_NAME =" + 
				"                               '"+cpxName+"'" + 
				"                           AND SUBSTR(CREATE_TIME_ORDER, 0, 4) = '2020'" + 
				...
				"                         WHERE product_id || '-' || product_line_name =" + 
				"                               '"+cpxName+"'" + 
				"                           AND SUBSTR(match_date, 0, 4) = '2020'" + 
				"                         GROUP BY CUSTOMER_NAME, group_type" + 
				"                        union all" + 
				"                        SELECT CUSTOMER_NAME 客户名," + 
				"                               group_type 内外部," + 
				...
				"                               COUNT(MID) 证书" + 
				"                          FROM T_ORDER_CERC" + 
				"                         WHERE product_line_uuid || '-' || PRODUCT_LINE_NAME =" + 
				"                               '"+cpxName+"'" + 
				"                           AND SUBSTR(FICTIONAL_DATE, 0, 4) = '2020'" + 
				"                         GROUP BY CUSTOMER_NAME, group_type)" + 
				"                 group by 客户名, 内外部" + 
				"                 order by 委托金额 desc) aa" + 
				"         where rownum <= 100" + 
				"           and aa.内外部 = '"+type+"') bb" + 
				" where rm > 0" );
		System.out.println(sql.toString());
	...
	public Map<String, Object> findJtgsTableKhQuyu(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append(" select *" + 
				...
				"                               0 as 委托单数量," + 
				"                               0 as 委托金额," + 
				"                               SUM(SYSTEM_MATCH_AMOUNT / 100) 实收," + 
				"                               0 as 证书" + 
				"                          FROM T_SERVER_INCOME" + 
	...
	public Map<String, Object> findJtgsTableGs(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("    select company_busi_org_name," + 
				...
				"           and substr(pay_end_date, 0, 4) = '2020'" + 
				"         GROUP BY SORG_LEVEL2, SORG_LEVEL3, company_busi_org_name)" + 
				" group by company_busi_org_name" + 
				" order by 年预测收入 desc" );
		System.out.println(sql.toString());
		List<Object[]> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	public Map<String, Object> findYyjyqkYhSrzeYear(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		String sql1 = " SELECT SUM(总开票 - 废票) 年业务收入" + 
				...
				"          FROM T_COMP_INVOICE_ALL" + 
				"         WHERE SUBSTR(INVOICE_DATE, 0, 4) = '2020'" + 
				"        UNION ALL" + 
				"        SELECT 0 总开票, SUM(EX_TAX_PRICE) AS 废票" + 
				"          FROM T_COMP_INVOICE_ALL" + 
				"         WHERE SUBSTR(VOID_TIME, 0, 4) = '2020')" ;
		System.out.println(sql1);
	...
	public Map<String, Object> findYyjyqkYhYwcbYear(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		String sql1 = " SELECT SUM(业务成本) 业务成本" + 
				...
				"          FROM T_COMPANY_COST_ALL" + 
				"         WHERE SUBSTR(PAY_END_DATE, 1, 4) = '2020'" + 
	...
	public Map<String, Object> findYyjyqkJtgsYhYwcbYear(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " select sum(业务成本) 业务成本" +
				"  from (SELECT SORG_LEVEL3," + 
				"               COMPANY_BUSI_ORG_ID," + 
				"               SUM((业务成本 + 间接费用 + 营业外支出 + 税金及附加 + 所得税费用)) AS 支出总额," + 
				"               SUM(业务成本) 业务成本," + 
				"               SUM(直接成本) 直接成本," + 
				"               SUM(间接成本) 间接成本" + 
				"          FROM (SELECT SORG_LEVEL3," + 
				"                       COMPANY_BUSI_ORG_ID," + 
				"                       (SUM(I_PAYMENT_AMOUNT) + SUM(PAYMENT_AMOUNT) +" + 
				"                       SUM(APPORT_PAY_AMOUNT) + SUM(CONTINU_PAYMENT_AMOUNT)) AS 业务成本," + 
				"                       (SUM(I_PAYMENT_AMOUNT) + SUM(PAYMENT_AMOUNT) +" + 
				"                       SUM(CONTINU_PAYMENT_AMOUNT)) AS 直接成本," + 
				"                       SUM(APPORT_PAY_AMOUNT) AS 间接成本," + 
				"                       0 AS 营业外支出," + 
				"                       0 AS 税金及附加," + 
				"                       0 AS 所得税费用," + 
				"                       0 AS 间接费用," + 
				...
				"                       0 AS 今日间接成本" + 
				"                  FROM T_COMPANY_COST_ALL" + 
				"                 WHERE SUBSTR(PAY_END_DATE, 0, 4) =" + 
				"                       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"                 GROUP BY SORG_LEVEL3, COMPANY_BUSI_ORG_ID)" + 
				"         WHERE SORG_LEVEL3 = '"+companyId+"'" + 
				"         GROUP BY SORG_LEVEL3, COMPANY_BUSI_ORG_ID)" ;
		System.out.println(sql1);
		List<BigDecimal> list = DBManager.get("kabBan").createNativeQuery(sql1).getResultList();
	...
	public Map<String, Object> findYyjyqkJtgsQuyuYhSrzeCpxywsr(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " select sum(SYSTEM_TAX_PRICE) 产品线业务" + 
				"  from (SELECT COMPANY_BUSI_ORG_ID," + 
				"               COMPANY_BUSI_ORG_NAME SORG_NAME," + 
				"               NVL(SUM(CASE" + 
				"                         WHEN SUBSTR(INVOICE_DATE, 0, 4) =" + 
				"                              TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') THEN" + 
				"                          EX_TAX_PRICE" + 
	...
	public Map<String, Object> findYyjyqkJtgsQuyuYhSrzeFcpxywsr(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " select sum(SYSTEM_TAX_PRICE) 非产品线业务收入" + 
				"  from (SELECT COMPANY_BUSI_ORG_ID," + 
				"               COMPANY_BUSI_ORG_NAME SORG_NAME," + 
				"               NVL(SUM(CASE" + 
				"                         WHEN SUBSTR(INVOICE_DATE, 0, 4) =" + 
	...
	public Map<String, Object> findYyjyqkJtgsQuyuYhSrzeDflywsr(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " select sum(SYSTEM_TAX_PRICE) 待分类业务" + 
				"  from (SELECT COMPANY_BUSI_ORG_ID," + 
				"               COMPANY_BUSI_ORG_NAME SORG_NAME," + 
				"               NVL(SUM(CASE" + 
				"                         WHEN SUBSTR(INVOICE_DATE, 0, 4) =" + 
	...
	public Map<String, Object> findYyjyqkJtgsQuyuYhSrzeQtywsr(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " select sum(SYSTEM_TAX_PRICE) 其他业务" + 
				"  from (SELECT COMPANY_BUSI_ORG_ID," + 
				"               COMPANY_BUSI_ORG_NAME SORG_NAME," + 
				"               NVL(SUM(CASE" + 
				"                         WHEN SUBSTR(INVOICE_DATE, 0, 4) =" + 
	...
	public Map<String, Object> findYyjyqkJtgsQuyuYhYwcbYear(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " SELECT SUM(APPORT_PAY_AMOUNT + DIRECT_COST) 业务成本" + 
				"  FROM T_COMPANY_COST_ALL" + 
	...
	public Map<String, Object> findYyjyqkJtgsQuyuYhYwcbZjcb(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " SELECT SUM(PAYMENT_AMOUNT + I_PAYMENT_AMOUNT + CONTINU_PAYMENT_AMOUNT) 直接成本" + 
				"  FROM T_COMPANY_COST_ALL" + 
				" WHERE BUSINESS_REGION = '"+companyId+"'" + 
				"   AND SUBSTR(PAY_END_DATE, 1, 4) =" + 
				"       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
	...
	public Map<String, Object> findYyjyqkJtgsQuyuYhYwcbJjcb(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		String sql1 = " SELECT SUM(APPORT_PAY_AMOUNT) 间接成本" + 
				"  FROM T_COMPANY_COST_ALL" + 
				" WHERE BUSINESS_REGION = '"+companyId+"'" + 
				"   AND SUBSTR(PAY_END_DATE, 1, 4) =" + 
				"       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
	...
	public Map<String, Object> findYwskByCpxYhWtdl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = " SELECT COUNT(DISTINCT(ORDER_UUID)) 年委托单" + 
				"  FROM T_ORDER_SERVER" + 
				" WHERE SUBSTR(CREATE_TIME_ORDER, 0, 4) = TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"   AND DATA_STATE_ORDER <> '已删除'" + 
				"   AND DATA_STATE_ORDER <> '草稿'" + 
				"   AND AUDIT_STATE_ORDER <> '草稿'" + 
		...
		map.put("result", NewUtils.returnTodayTotalIntMsg2020("年委托单", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findYwskByCpxYhKgdl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = " SELECT COUNT(DISTINCT(ORDER_UUID)) 年开工" + 
				"  FROM T_ORDER_SERVER" + 
				" WHERE SUBSTR(JOB_START_TIME_ORDER, 0, 4) =" + 
				"       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"   AND PRODUCT_LINE_UUID || '-' || PRODUCT_LINE_NAME = '"+companyId+"'" + 
				"   AND DATA_STATE_ORDER <> '已删除'" + 
				"   AND DATA_STATE_ORDER <> '草稿'" + 
		...
		map.put("result", NewUtils.returnTodayTotalIntMsg2020("年开工", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findYwskByCpxYhWgdl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "  SELECT COUNT(DISTINCT(ORDER_UUID)) 年完工单量" + 
				"  FROM T_ORDER_SERVER" + 
				" WHERE SUBSTR(JOB_END_TIME_ORDER, 0, 4) =" + 
				"       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"   AND PRODUCT_LINE_UUID || '-' || PRODUCT_LINE_NAME = '"+companyId+"'" ;
		System.out.println("----------" + sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
		...
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("result", NewUtils.returnTodayTotalIntMsg2020("年完工单量", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findYwskByCpxYhKhsl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "SELECT COUNT(DISTINCT(CUSTOMER_NAME)) 年客户" + 
				"  FROM T_ORDER_CRM" + 
		...
		map.put("result", NewUtils.returnTodayTotalIntMsg2020("年客户", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findYwskByCpxYhGyssl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		String sql = "   SELECT COUNT(DISTINCT CASE" + 
				"               WHEN SUBSTR(CREATE_TIME_ORDER, 0, 4) =" + 
				"                    TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') THEN" + 
				"                SUB_PACKAGE_NAME" + 
				"             END) 年供应商" + 
				"  FROM T_ORDER_SRM" + 
				" WHERE PRODUCT_ID || '-' || PRODUCT_NAME = '"+companyId+"'" + 
		...
		map.put("result", NewUtils.returnTodayTotalIntMsg2020("年供应商", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findYwskByCpxYhCzsl(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "   SELECT COUNT(MID) 年证书" + 
				"  FROM T_ORDER_CERC" + 
		...
		map.put("result", NewUtils.returnTodayTotalIntMsg2020("年证书", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findSzskByCpxYhWtje(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "   SELECT NVL(SUM(SYS_CUR_TOTAL_AMOUNT), 0) 年委托金额" + 
				"  FROM T_ORDER_SERVER" + 
				" WHERE SUBSTR(CREATE_TIME_ORDER, 0, 4) =" + 
				"       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"   AND DATA_STATE_ORDER <> '已删除'" + 
		...
		map.put("result", NewUtils.returnTodayTotalDoubleMsg2020("年委托金额", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findSzskByCpxYhKgje(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "   SELECT SUM(SYS_CUR_TOTAL_AMOUNT) 年开工金额" + 
				"  FROM T_ORDER_SERVER" + 
				" WHERE JOB_START_TIME_ORDER IS NOT NULL" + 
				"   AND SUBSTR(JOB_START_TIME_ORDER, 1, 4) =" + 
				"       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"   AND PRODUCT_LINE_UUID || '-' || PRODUCT_LINE_NAME = '0101-矿产品'" ;
		System.out.println("----------" + sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
		...
		map.put("result", NewUtils.returnTodayTotalDoubleMsg2020("年开工金额", res,null, df));
		return map;
	...
	public Map<String, Object> findSzskByCpxYhYcsr(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "     SELECT NVL(SUM(SYS_CUR_TOTAL_AMOUNT), 0) 年预测收入" + 
				"  FROM T_ORDER_SERVER" + 
				" WHERE SUBSTR(WORK_FINISH_TIME, 0, 4) =" + 
				"       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"   AND DATA_STATE_ORDER <> '已删除'" + 
				"   AND DATA_STATE_ORDER <> '草稿'" + 
				"   AND AUDIT_STATE_ORDER <> '草稿'" + 
		...
		map.put("result", NewUtils.returnTodayTotalDoubleMsg2020("年预测收入", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findSzskByCpxYhYwsr(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "   SELECT ROUND(NVL(SUM(CASE" + 
				"                       WHEN SUBSTR(INVOICE_DATE, 0, 4) =" + 
				"                            TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') THEN" + 
				"                        EX_TAX_PRICE" + 
				"                     END)," + 
		...
		map.put("result", NewUtils.returnTodayTotalDoubleMsg2020("年业务收入", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findSzskByCpxYhYwcb(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		Map<String, String> reMap = fetchWebReq.getData();
		String companyId = reMap.get("companyId");
		String sql = "  SELECT SUM(PAYMENT_AMOUNT + I_PAYMENT_AMOUNT + APPORT_PAY_AMOUNT +" + 
		...
		map.put("result", NewUtils.returnTodayTotalDoubleMsg2020("年业务成本", res,null, df));
		return map;
	}
	...
	public Map<String, Object> findSzskByCpxYhMll(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		String companyId = reMap.get("companyId");
		String sql = " SELECT " + 
				"       NVL(round( (年业务收入 - 业务成本) / 年业务收入 * 100,2)," + 
				"           0) 毛利率" + 
				...
				" RIGHT JOIN" + 
				" (SELECT PT.PRODUCT_LINE_UUID PRODUCT_ID," + 
				"         PRODUCT_LINE_NAME," + 
				"         NVL(业务成本, 0) 业务成本" + 
				"    FROM (SELECT PRODUCT_ID, SUM(TOTAL_COST) AS 业务成本" + 
				"            FROM T_COMPANY_COST_ALL" + 
				"           WHERE SUBSTR(PAY_END_DATE, 0, 4) =" + 
				"                 TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"           GROUP BY PRODUCT_ID) T" + 
				"   RIGHT JOIN PRODUCT_LINE_ALL PT" + 
				"      ON T.PRODUCT_ID = PT.PRODUCT_LINE_UUID) B" + 
	...
	public Map<String, Object> findSzByCpx(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		String sql = "SELECT SUM(A.收入) OVER(ORDER BY A.月份) 收入," + 
				...
				"  FROM (SELECT SUM(收入 - 废票) 收入, 月份" + 
				"          FROM (SELECT SUM(EX_TAX_PRICE) AS 收入," + 
				"                       0 AS 废票," + 
				"                       SUBSTR(INVOICE_DATE, 1, 7) 月份" + 
				"                  FROM T_COMP_INVOICE_ALL" + 
				"                 WHERE TYPE IN ('产品线业务')" + 
				"                   AND SUBSTR(INVOICE_DATE, 0, 4) =" + 
				"                       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"                   AND PRODUCT_ID || '-' || PRODUCT_LINE_NAME = '"+companyId+"'" + 
				"                 GROUP BY PRODUCT_LINE_NAME, SUBSTR(INVOICE_DATE, 1, 7)" + 
				"                UNION ALL" + 
				"                SELECT 0 AS 收入," + 
				"                       SUM(EX_TAX_PRICE) AS 废票," + 
				"                       SUBSTR(VOID_TIME, 1, 7) 月份" + 
				"                  FROM T_COMP_INVOICE_ALL" + 
				"                 WHERE TYPE IN ('产品线业务')" + 
				"                   AND SUBSTR(VOID_TIME, 0, 4) =" + 
				"                       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"                   AND PRODUCT_ID || '-' || PRODUCT_LINE_NAME = '"+companyId+"'" + 
				"                 GROUP BY PRODUCT_LINE_NAME, SUBSTR(VOID_TIME, 1, 7))" + 
				"         GROUP BY 月份) A" + 
	...
	public Map<String, Object> findYwskMsgSql1(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append(" select sum(ORDER_CREATE_COUNT) 委托单数量," + 
		...
		if (resultList != null && resultList.size() > 0) {
			JSONArray ja = NewUtils.returnYwskMsgSql2020(resultList);
			map.put("result", ja);
		}
	...
	public Map<String, Object> findYwskMsgSql2(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("  SELECT NVL(round((年业务收入 - 业务成本) / 年业务收入 * 100, 2), 0) 毛利率" + 
				...
				"                         WHEN SUBSTR(INVOICE_DATE, 0, 4) = '2020' THEN" + 
				"                          EX_TAX_PRICE" + 
				"                       END)," + 
				"                   0) - NVL(SUM(CASE" + 
				"                                  WHEN SUBSTR(VOID_TIME, 0, 4) = '2020' THEN" + 
				"                                   EX_TAX_PRICE" + 
				"                                END)," + 
				"                            0) 年业务收入" + 
				"          FROM T_COMP_INVOICE_ALL" + 
				"         WHERE TYPE = '产品线业务'" + 
				"           and SORG_LEVEL3 = '"+companyId+"') A," + 
	...
	public Map<String, Object> findYwskMsgSql3(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		if (resultList != null && resultList.size() > 0) {
			JSONObject ja = NewUtils.returnKhslMsgSql2020(resultList, 1);
			map.put("result", ja);
		}
	...
	public Map<String, Object> findYwskMsgSql4(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append(" SELECT SUM(年供应商数量) 供应商数量," + 
				...
				"                    COUNT(DISTINCT SUB_PACKAGE_NAME) 业务供应商数量" + 
				"               FROM T_ORDER_SRM" + 
				"              WHERE SUBSTR(CREATE_TIME_ORDER, 0, 4) >=" + 
				"                    TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
		...
		if (resultList != null && resultList.size() > 0) {
			JSONObject ja = NewUtils.returnGysMsgSql2020(resultList, 1);
			map.put("result", ja);
		}
	...
	public Map<String, Object> findYwskMsgSql5(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("  SELECT 年出证数量," + 
				...
				"               SORG_LEVEL3" + 
				"          FROM T_ORDER_CERC" + 
				"         WHERE SUBSTR(FICTIONAL_DATE, 1, 4) = '2020'" + 
				"           AND STATE = '已完成'" + 
				"         GROUP BY SORG_LEVEL3)" + 
				" WHERE SORG_LEVEL3 = '"+companyId+"'" );
		System.out.println(sql.toString());
		...
		if (resultList != null && resultList.size() > 0) {
			JSONObject ja = NewUtils.returnCzslMsgSql2020(resultList);
			map.put("result", ja);
		}
	...
	public Map<String, Object> findYwskMsgSql1JtWtdlYear(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		sql.append("  SELECT COUNT(年委托单量) 年委托单量" + 
				...
				"            FROM T_ORDER_SERVER" + 
				"           WHERE SUBSTR(CREATE_TIME_ORDER, 1, 4) = '2020'" + 
				"           GROUP BY ORDER_UUID)");
		System.out.println(sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	public Map<String, Object> findYwskMsgSql1JtKgdlYear(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		sql.append(" SELECT COUNT(年开工单量) 年开工单量" + 
				...
				"          FROM T_ORDER_SERVER" + 
				"         WHERE SUBSTR(JOB_START_TIME_ORDER, 1, 4) = '2020'" + 
				"           AND JOB_START_TIME_ORDER IS NOT NULL" + 
				"         GROUP BY ORDER_UUID)" );
		System.out.println(sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	public Map<String, Object> findYwskMsgSql1JtWgdlYear(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		sql.append(" SELECT COUNT(年完工单量) 年完工单量" + 
				...
				"          FROM T_ORDER_SERVER" + 
				"         WHERE SUBSTR(JOB_END_TIME_ORDER, 1, 4) = '2020'" + 
				"         GROUP BY ORDER_UUID)");
		System.out.println(sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	public Map<String, Object> findYwskMsgSql2Jt(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("  SELECT NVL(round((年业务收入 - 业务成本) / 年业务收入 * 100, 2), 0) 毛利率" + 
				...
				"       (SELECT SUM(TOTAL_COST) AS 业务成本" + 
				"          FROM T_COMPANY_COST_ALL" + 
				"         WHERE SUBSTR(PAY_END_DATE, 0, 4) = '2020') B");
		System.out.println(sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	public Map<String, Object> findYwskMsgSql3JtKhslFhy(FetchWebRequest<Map<String, String>> fetchWebReq)
		...
		sql.append("   SELECT 年客户数量 - 活跃客户数量 非活跃客户数量" + 
				...
				"          FROM VIEW_CUSTOMER_ALL" + 
				"         where substr(create_time, 0, 4) = '2020') A," + 
				"       (SELECT COUNT(DISTINCT CUSTOMER_NAME) 活跃客户数量" + 
				"          FROM T_ORDER_CRM" + 
				"         where substr(create_time_order, 0, 4) = '2020') B" );
		System.out.println(sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	public Map<String, Object> findYwskMsgSql4Jt(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		if (resultList != null && resultList.size() > 0) {
			JSONObject ja = NewUtils.returnGysMsgSql2020(resultList, 0);
			map.put("result", ja);
		}
	...
	public Map<String, Object> findYwskMsgSql2Quyu(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append(
				" SELECT case" + 
				"         when 年业务收入 is null or 年业务收入 = 0 then" + 
				"          0" + 
				"         else" + 
				"          round((年业务收入 - 业务成本) / 年业务收入 * 100, 2)" + 
				"       end 产品线毛利率" + 
				...
				"           and BUSINESS_REGION = '"+companyId+"'" + 
				"           AND TYPE = '产品线业务'" + 
				"           AND SUBSTR(INVOICE_DATE, 0, 4) = '2020') A," + 
				"       (SELECT SUM(TOTAL_COST) AS 业务成本" + 
				"          FROM T_COMPANY_COST_ALL" + 
				"         WHERE SUBSTR(PAY_END_DATE, 0, 4) = '2020'" + 
				"           and BUSINESS_REGION = '"+companyId+"') B" );
		System.out.println(sql.toString());
		List<BigDecimal> resultList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	public Map<String, Object> findYwskMsgSql3Quyu(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append(" SELECT SUM(年客户数量) 年客户数量," + 
				"       SUM(活跃客户数量 - NVL(非产品线活跃客户, 0)) 产品线活跃客户数量," + 
				"       SUM(NVL(非产品线活跃客户, 0)) 非产品线活跃客户," + 
				"       A.BUSINESS_REGION" + 
				...
				"                    COUNT(DISTINCT CUSTOMER_NAME) 活跃客户数量" + 
				"               FROM T_ORDER_CRM" + 
				"              WHERE SUBSTR(CREATE_TIME_ORDER, 0, 4) >=" + 
				"                    TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				...
				"    ON A.BUSINESS_REGION = E.BUSINESS_REGION" + 
		...
		if (resultList != null && resultList.size() > 0) {
			JSONObject ja = NewUtils.returnKhslMsgSql2020(resultList, 3);
			map.put("result", ja);
		}
	...
	public Map<String, Object> findYwskMsgSql4Quyu(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("  SELECT SUM(年供应商数量) 供应商数量," + 
				"       SUM(年供应商数量 - NVL(非产品线活跃供应商, 0)) 产品线活跃供应商数量," + 
				"       SUM(NVL(非产品线活跃供应商, 0)) 非产品线活跃供应商," + 
				"       A.BUSINESS_REGION" + 
				"  FROM (SELECT BUSINESS_REGION," + 
				"               COUNT(DISTINCT SUB_PACKAGE_NAME) 年供应商数量" + 
				"          FROM T_ORDER_SRM" + 
				"         WHERE SUBSTR(CREATE_TIME_ORDER, 0, 4) =" + 
				"               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')" + 
				"           AND BUSINESS_REGION IS NOT NULL" + 
		...
		if (resultList != null && resultList.size() > 0) {
			JSONObject ja = NewUtils.returnGysMsgSql2020(resultList, 3);
			map.put("result", ja);
		}
	...
	public Map<String, Object> findJtgsSrbar(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		...
		sql.append("   SELECT *" + 
				...
				"                            0) 开票收入" + 
				"          FROM T_COMP_INVOICE_ALL" + 
				"         WHERE GOODS_MEDIUMCLASS_NAME IS NOT NULL" + 
				"           AND PRODUCT_ID || '-' || PRODUCT_LINE_NAME = '"+companyId+"'" + 
	...
	@RpcMethod(loginValidate = false)
	@Override
	public Map<String, Object> findYwjyqstZj(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		// TODO Auto-generated method stub
		String sql = "SELECT to_number(INVOICE_DATE) || '月' INVOICE_DATE,  " + 
				"        总开票,  " + 
				"       CASE  " + 
				"         WHEN INVOICE_DATE = 1 THEN  " + 
				"          0  " + 
				"         ELSE  " + 
				"         round( (总开票 - LAG(总开票, 1, 0) OVER(ORDER BY INVOICE_DATE)) / 总开票 * 100,2)  " + 
				"       END 开票环比,  " + 
				"       业务成本,  " + 
				"       CASE  " + 
				"         WHEN INVOICE_DATE = 1 THEN  " + 
				"          0  " + 
				"         ELSE  " + 
				"         round( (业务成本 - LAG(业务成本, 1, 0) OVER(ORDER BY INVOICE_DATE)) / 业务成本 * 100,2)  " + 
				"       END AS 成本环比         " + 
				"  FROM (SELECT SUM(总开票) 总开票, SUM(业务成本) 业务成本, INVOICE_DATE  " + 
				"          FROM (SELECT SUM(总开票 - 废票) 总开票, 0 AS 业务成本, INVOICE_DATE  " + 
				"                  FROM (SELECT SUM(EX_TAX_PRICE) 总开票,  " + 
				"                               0 AS 废票,  " + 
				"                               SUBSTR(INVOICE_DATE, 6, 2) INVOICE_DATE  " + 
				"                          FROM T_COMP_INVOICE_ALL  " + 
				"                         WHERE SUBSTR(INVOICE_DATE, 0, 4) =  " + 
				"                               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')  " + 
				"                         GROUP BY SUBSTR(INVOICE_DATE, 6, 2)  " + 
				"                        UNION ALL  " + 
				"                        SELECT 0 总开票,  " + 
				"                               SUM(EX_TAX_PRICE) AS 废票,  " + 
				"                               SUBSTR(VOID_TIME, 6, 2)  " + 
				"                          FROM T_COMP_INVOICE_ALL  " + 
				"                         WHERE SUBSTR(VOID_TIME, 0, 4) =  " + 
				"                               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')  " + 
				"                         GROUP BY SUBSTR(VOID_TIME, 6, 2))  " + 
				"                 GROUP BY INVOICE_DATE  " + 
				"                UNION ALL  " + 
				"                SELECT 0 AS 总开票,  " + 
				"                       SUM(APPORT_PAY_AMOUNT + DIRECT_COST) 业务成本,  " + 
				"                       SUBSTR(PAY_END_DATE, 6, 2) PAY_END_DATE  " + 
				"                  FROM T_COMPANY_COST_ALL  " + 
				"                 WHERE SUBSTR(PAY_END_DATE, 1, 4) =  " + 
				"                       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY')  " + 
				"                 GROUP BY SUBSTR(PAY_END_DATE, 6, 2))  " + 
				"         GROUP BY INVOICE_DATE  " + 
				"         ORDER BY 3)" ;
		System.out.println(sql);
		List<Object[]> reList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
		
		return NewUtils.returnYwjyqstObj(reList);
	}

	@RpcMethod(loginValidate = false)
	@Override
	public Map<String, Object> findYwjyqstGs(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		// 获取当前公司id
		Map<String, String> resMap = fetchWebReq.getData();
		String companyId = resMap.get("companyId");
		String sql = "SELECT to_number(INVOICE_DATE) || '月' INVOICE_DATE, 总开票, " + 
				"       CASE " + 
				"         WHEN INVOICE_DATE = 01 THEN " + 
				"          0 " + 
				"         ELSE " + 
				"          round(DECODE(总开票, " + 
				"                 0, " + 
				"                 0, " + 
				"                 (总开票 - LAG(总开票, 1, 0) " + 
				"                  OVER(PARTITION BY SORG_LEVEL3 ORDER BY INVOICE_DATE)) / 总开票 * 100), 2) " + 
				"       END 开票环比, " + 
				"       业务成本, " + 
				"       CASE " + 
				"         WHEN INVOICE_DATE = 01 THEN " + 
				...
				"                 0, " + 
				"                 (业务成本 - LAG(业务成本, 1, 0) " + 
				"                  OVER(PARTITION BY SORG_LEVEL3 ORDER BY INVOICE_DATE)) / 业务成本 * 100),2) " + 
				"       END 成本环比 " + 
				"  FROM (SELECT SUM(总开票) 总开票, " + 
				"               SUM(业务成本) 业务成本, " + 
				"               SORG_LEVEL3, " + 
				"               INVOICE_DATE " + 
				"          FROM (SELECT SUM(总开票 - 废票) 总开票, " + 
				"                       0 AS 业务成本, " + 
				"                       SORG_LEVEL3, " + 
				"                       INVOICE_DATE " + 
				"                  FROM (SELECT SUM(EX_TAX_PRICE) 总开票, " + 
				...
				"                         WHERE SUBSTR(INVOICE_DATE, 0, 4) = " + 
				"                               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') " + 
				"                         GROUP BY SUBSTR(INVOICE_DATE, 6, 2), SORG_LEVEL3 " + 
				"                        UNION ALL " + 
				"                        SELECT 0 总开票, " + 
				"                               SUM(EX_TAX_PRICE) AS 废票, " + 
				"                               SORG_LEVEL3, " + 
				...
				"                         WHERE SUBSTR(VOID_TIME, 0, 4) = " + 
				"                               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') " + 
				"                         GROUP BY SUBSTR(VOID_TIME, 6, 2), SORG_LEVEL3) " + 
				"                 GROUP BY INVOICE_DATE, SORG_LEVEL3 " + 
				"                UNION ALL " + 
				"                SELECT 0 AS 总开票, " + 
				"                       SUM(APPORT_PAY_AMOUNT + DIRECT_COST) 业务成本, " + 
				"                       SORG_LEVEL3, " + 
				...
				"                 WHERE SUBSTR(PAY_END_DATE, 1, 4) = " + 
				"                       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') " + 
				"                 GROUP BY SUBSTR(PAY_END_DATE, 6, 2), SORG_LEVEL3) " + 
				"         GROUP BY INVOICE_DATE, SORG_LEVEL3 " + 
				"         ORDER BY SORG_LEVEL3, INVOICE_DATE) " + 
				" WHERE SORG_LEVEL3 = '"+companyId+"'" ;
		System.out.println(sql);
		List<Object[]> reList = DBManager.get("kabBan").createNativeQuery(sql.toString()).getResultList();
	...
	@RpcMethod(loginValidate = false)
	@Override
	public Map<String, Object> findYwjyqstQyGs(FetchWebRequest<Map<String, String>> fetchWebReq) throws Exception {
		// 获取当前公司id
		Map<String, String> resMap = fetchWebReq.getData();
		String companyId = resMap.get("companyId");
		String sql = "SELECT to_number(INVOICE_DATE) || '月' INVOICE_DATE, 总开票, " + 
				...
				"                 0, " + 
				"                 (总开票 - LAG(总开票, 1, 0) " + 
				"                  OVER(PARTITION BY BUSINESS_REGION ORDER BY INVOICE_DATE)) / 总开票 * 100),2) " + 
				"       END 开票环比, " + 
				"       业务成本, " + 
				"       CASE " + 
				"         WHEN INVOICE_DATE = 01 THEN " + 
				...
				"                 0, " + 
				"                 (业务成本 - LAG(业务成本, 1, 0) " + 
				"                  OVER(PARTITION BY BUSINESS_REGION ORDER BY INVOICE_DATE)) / 业务成本 * 100),2) " + 
				"       END 成本环比 " + 
				"  FROM (SELECT SUM(总开票) 总开票, " + 
				"               SUM(业务成本) 业务成本, " + 
				"               BUSINESS_REGION, " + 
				...
				"                         WHERE SUBSTR(INVOICE_DATE, 0, 4) = " + 
				"                               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') " + 
				"                         GROUP BY SUBSTR(INVOICE_DATE, 6, 2), BUSINESS_REGION " + 
				"                        UNION ALL " + 
				"                        SELECT 0 总开票, " + 
				"                               SUM(EX_TAX_PRICE) AS 废票, " + 
				"                               BUSINESS_REGION, " + 
				...
				"                         WHERE SUBSTR(VOID_TIME, 0, 4) = " + 
				"                               TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') " + 
				"                         GROUP BY SUBSTR(VOID_TIME, 6, 2), BUSINESS_REGION) " + 
				"                 GROUP BY INVOICE_DATE, BUSINESS_REGION " + 
				"                UNION ALL " + 
				"                SELECT 0 AS 总开票, " + 
				"                       SUM(APPORT_PAY_AMOUNT + DIRECT_COST) 业务成本, " + 
				"                       BUSINESS_REGION, " + 
				...
				"                 WHERE SUBSTR(PAY_END_DATE, 1, 4) = " + 
				"                       TO_CHAR(ADD_MONTHS(SYSDATE, -12), 'YYYY') " + 
				"                 GROUP BY SUBSTR(PAY_END_DATE, 6, 2), BUSINESS_REGION) " + 
				"         GROUP BY INVOICE_DATE, BUSINESS_REGION " + 
