 ...
 */
@Entity
@Table(name = "t_customer_approval")
public class CustomerApproval {
	...
	public CustomerApproval(String busOwnId, String country, String countryName, String countryNo, String province,
			...
			String enterpriseCode, String riskLevel, String recordDate, String quickCode, String cmpanyPic,
			String staffId, String alive, String lable, String lat, String lng, String hasShare, String hasPower,String deptId) {
		super();
		this.busOwnId = busOwnId;
		this.country = country;
		this.countryName = countryName;
